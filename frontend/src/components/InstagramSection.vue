    ...
    <div class="max-w-7xl mx-auto w-full">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12">
          ...
          <div v-if="data.topPosts && data.topPosts.length > 0" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8">
            <div v-for="post in data.topPosts" :key="post.id" class="no-break flex flex-col shadow-md rounded-lg overflow-hidden">
          ...
          <div v-else class="bg-white rounded-2xl p-8 text-center border border-gray-100 mt-6 mb-8">
    ...
    <div class="max-w-7xl mx-auto w-full">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12">
          ...
          <div v-if="data.topStories && data.topStories.length > 0" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8">
            <div v-for="story in data.topStories" :key="story.id" class="no-break flex flex-col shadow-sm border border-orange-100 rounded-2xl overflow-hidden hover:shadow-md transition-shadow bg-white">
              <div class="bg-gray-100 h-72 flex justify-center items-center relative overflow-hidden p-1">
              ...
              <div class="p-5 flex flex-col gap-0.5 bg-orange-50/30">
