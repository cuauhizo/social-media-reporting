    ...
    const fullReport = {
      ...
      facebook: {
        ...
        kpis: {
          ...
          new_followers_diff: calcDiff(fbOverview.new_followers, fbOverviewPrev.new_followers),
          ...
          post_engagement_rate_diff: calcDiff(fbOverview.engagement_rate, fbOverviewPrev.engagement_rate),
